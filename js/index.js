...
document.addEventListener('DOMContentLoaded', function () {
    ...
    xhr.open('GET', 'http://localhost:8080/api/v1/manages', false); // gửi đi đâu, theo cách nào.
...
function deleteProduct(id) {
    ...
    if (confirm('Are you sure?')) {
        ...
        xhr.open('DELETE', 'http://localhost:8080/api/v1/manages/' + id, false); // gửi đi đâu, theo cách nào.
        xhr.send(); // phóng xe đi. 
    }
}